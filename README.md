...
2. **Clone the Repository**:
   Run the following command in a Colab cell to clone the repository:
   ```bash
   !git clone https://github.com/AyushaSanjuktha/SutraSarathi-.git
   %cd SutraSarathi
   ```
...
4. **Set Up ngrok Token**:
   Authenticate ngrok by running the following command:
   ```bash
...
6. **Access the Gradio Interface**:
   - Once the app starts, you'll see a public URL (generated by ngrok) in the Colab output.
